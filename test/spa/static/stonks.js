...
var stonksScript = document.currentScript;
var useHashRouting = stonksScript?.getAttribute("data-hash-routing") !== null;
var environment = {
...
function shouldBlockEvent() {
  if (environment.isLocalhost && !(stonksScript?.getAttribute("data-allow-localhost") === "true" ? true : false)) {
    return true;
  }
